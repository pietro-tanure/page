...
export const THEORY: Block[] = [
  {
    ...
    items: [
      ...
      {
        text: `Não é uma lente exclusiva:`,
        sub: [
          `Liberal/nacionalista: enfatiza ideias, agência individual (Bismarck, Cavour)`,
          `Sistema-mundo/dependência (Wallerstein, 1974–89; Rodney, 1972): troca centro-periferia em vez de luta de classes`,
        ],
      },
    ],
  },
...
> = {
  ingles: {
    ...
    blocks: [
      ...
      { type: 'subheading', text: 'Ressalva — leitura contestada' },
      {
        type: 'bullets',
        items: [
          {
            text: `Historiadores revisionistas (Russell, Kishlansky; Trevor-Roper contra a tese de Tawney da "ascensão da pequena nobreza") argumentam que a revolução foi movida por uma crise religiosa/constitucional contingente (a má gestão de Carlos I, as Guerras dos Bispos escocesas, facções da corte), e não por um projeto de classe burguês coerente — o "interesse de classe" pode impor mais coerência retrospectiva do que os próprios atores realmente tinham`,
          },
        ],
      },
    ],
...
export const TIMELINE_EVENTS: { year: number; label: string; tab: TimelineTab }[] = [
  ...
  { year: 1787, label: 'Constituição dos EUA', tab: 'americana' },
  { year: 1789, label: 'Revolução Francesa', tab: 'francesa' },
